...
public class SolverGolosoTest {
	...
	private Empresa inicializar() {
		...
		emp.agregar(new Oferta("Juan", 0, 2, 300,"Comedia","10/4/2024"));
		emp.agregar(new Oferta("Pablo", 3, 5, 700,"Musical","10/4/2024"));
		emp.agregar(new Oferta("Pedro", 2, 6, 1000,"Teatro","10/4/2024"));
		emp.agregar(new Oferta("Pepe", 7, 10, 800,"Comedia","10/4/2024"));
		emp.agregar(new Oferta("Carlos", 12, 15, 100,"Charla","10/4/2024"));
		emp.agregar(new Oferta("Fran", 14, 16, 2000,"Teatro","10/4/2024"));
	...
	public void hayUnaSolaOfertaTest() {
	    Empresa emp = new Empresa();
	    emp.agregar(new Oferta("Ana", 0, 3, 500, "Drama","10/4/2024"));
	...
	public void ofertasConMismasCondicionesTest() {
	    Empresa emp = new Empresa();
	    emp.agregar(new Oferta("Jose", 1, 4, 400, "Cine","10/4/2024"));
	    emp.agregar(new Oferta("Maria", 1, 4, 400, "Cine","10/4/2024"));
	    emp.agregar(new Oferta("Luis", 1, 4, 400, "Cine","10/4/2024"));
